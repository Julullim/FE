...
import goods from "../../assets/common/navbar/m/Notice.png"
import goodsClick from "../../assets/common/navbar/m/notice_Click.png"
...
const Navbar: React.FC<NavbarProps> = ({ text }) => {
    ...
    return (
        <div>
            ...
            <Mobile>
            <div className="w-[100vw] h-[9.1vh] flex justify-center items-center fixed bottom-0 bg-white">
