    ...
    return (
        <div className="w-[100vw] h-[6.4vh] flex items-center bg-white" style={{ position: 'absolute', top: 0 }}>
            ...
            <div className="flex ml-[9.9vw] font-pt text-[2.2vh] text-darkgray gap-[3.8vw] items-center">
                <div className="w-[5.3vw] text-center" onClick={() => handleNavClick('notice')}>공지사항</div>
                <div className="w-[5.3vw] text-center" onClick={() => handleNavClick('calender')}>캘린더</div>
                <div className="w-[5.3vw] text-center" onClick={() => handleNavClick('reservation')}>동방예약</div>
                <div className="w-[5.3vw] text-center" onClick={() => handleNavClick('goods')}>굿즈</div>
                <div className="w-[5.3vw] text-center" onClick={() => handleNavClick('setlist')}>전지</div>
            </div>
